...
<div class="main">
	...
	<div id="section-rewards">
		...
		<div class="des"><p><?php echo date("m月d日",strtotime('-1 day'));?></p></div>
		<?php
		...
		for($i=0;$i<count($list);$i++){
			...
			echo "<ul><li class=\"f-cb\"><div class=\"f-fl\">".$list[$i]['name']."</div><div style=\" margin-left:10px\" class=\"f-fl\">".hidtel($list[$i]['tel'])."</div><div class=\"f-fr\">".$yours."</div></li></ul>";
		}
	?>
